<x-landing-layout>
    <div class="w-full">
        <img class="w-auto" src="{{asset('image/background.png')}}"/>
    </div>
    ...
    <div class="w-full p-12">
        ...
        <div class="flex gap-6">
            <div class="p-8 m-4 mr-0 bg-white rounded-md shadow-sm w-1/2">
                <h2 class="text-center font-bold text-4xl">Total Pemasukan </h2>
                <p class="font-bold text-3xl mt-6">Rp. {{ $pemasukan->sum('nominal') }}</p>
            ...
            <div class="p-8 m-4 ml-0 bg-white rounded-md shadow-sm w-1/2">
                <h2 class="text-center font-bold text-4xl">Total Pengeluaran </h2>
                <p class="font-bold text-3xl mt-6">Rp. {{ $pengeluaran->sum('nominal') }}</p>
